...
async def access_control(request: Request, call_next):
    ...
    try:
        if url.startswith("/api"):
            ...
            cookies["Authorization"] = "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6NiwiZW1haWwiOiJkcmVhbWVycmFtQG5hdmVyLmNvbSIsIm5hbWUiOm51bGwsInBob25lX251bWJlciI6bnVsbCwicHJvZmlsZV9pbWciOm51bGwsInNuc190eXBlIjpudWxsfQ.ILcxPNrwsyHc7RvqUzS1FLeqh1s8r6xoUUsTVKOPQiI"
